...
CREATE TABLE IF NOT EXISTS messages (
    ...
    createdAt BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
...
CREATE TABLE IF NOT EXISTS message_reactions (
    ...
    react_timestamp BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
...
CREATE TABLE IF NOT EXISTS ip_cache (
    ...
    last_sync BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
    PRIMARY KEY (ip)
);
...
CREATE TABLE IF NOT EXISTS cache (
    ...
    data LONGTEXT NOT NULL,
    last_update BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
    created BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
    PRIMARY KEY (rowId)
);
...
CREATE TABLE IF NOT EXISTS members (
    ...
    joined BIGINT NOT NULL DEFAULT (UNIX_TIMESTAMP(CURRENT_TIMESTAMP(3)) * 1000),
